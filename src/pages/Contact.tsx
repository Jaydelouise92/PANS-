      ...
      <section className="py-5 px-6 bg-amber-50 border-b border-amber-200">
        <div className="max-w-5xl mx-auto flex gap-3 items-start">
          ...
          <p className="text-sm text-amber-800">
            <strong>Please note:</strong> PANS does not provide legal advice or emergency assistance. If you are in crisis, call <a href="tel:131114" className="font-bold underline decoration-amber-300 hover:text-amber-900 transition-colors">Lifeline on 13 11 14</a>. For legal advice, contact <a href="tel:1300792387" className="font-bold underline decoration-amber-300 hover:text-amber-900 transition-colors">Victoria Legal Aid on 1300 792 387</a>.
          </p>
        </div>
      </section>
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="bg-white border border-purple-100 rounded-2xl p-6">
              ...
              <div className="space-y-2 text-xs text-stone-600">
                <p><strong>Lifeline:</strong> <a href="tel:131114" className="hover:text-brand-primary hover:underline transition-colors">13 11 14</a> (24/7 crisis support)</p>
                <p><strong>Victoria Legal Aid:</strong> <a href="tel:1300792387" className="hover:text-brand-primary hover:underline transition-colors">1300 792 387</a></p>
                <p><strong>Child Protection (DFFH):</strong> <a href="tel:131278" className="hover:text-brand-primary hover:underline transition-colors">13 12 78</a></p>
                <p><strong>Emergency:</strong> <a href="tel:000" className="hover:text-brand-primary hover:underline transition-colors">000</a></p>
              </div>
            </div>
          </div>
