          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="bg-white border border-purple-100 rounded-2xl p-6">
              ...
              <div className="space-y-2 text-xs text-stone-600">
                <p><strong>Lifeline:</strong> <a href="tel:131114" className="hover:underline">13 11 14</a> (24/7 crisis support)</p>
                <p><strong>Victoria Legal Aid:</strong> <a href="tel:1300792387" className="hover:underline">1300 792 387</a></p>
                <p><strong>Child Protection (DFFH):</strong> <a href="tel:131278" className="hover:underline">13 12 78</a></p>
                <p><strong>Emergency:</strong> <a href="tel:000" className="hover:underline">000</a></p>
              </div>
            </div>
          </div>
