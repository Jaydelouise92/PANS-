...
import { Clock, Scale, BookOpen, Gavel, Heart, ExternalLink, ArrowRight } from 'lucide-react';
    ...
    <div className="pt-16">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-serif text-stone-900 mb-4">PANS Guides</h2>
          <p className="text-stone-500 mb-10">Written in plain language for parents navigating the system.</p>
      ...
      <section className="py-20 px-6 bg-brand-secondary">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-serif text-stone-900 mb-4">External Services & Links</h2>
          <p className="text-stone-500 mb-10">Verified links to government, legal, and support services in Victoria.</p>
          <div className="grid md:grid-cols-2 gap-4">
            {externalLinks.map((link, i) => (
              <a
                ...
                className="group bg-white p-5 rounded-2xl border border-purple-100 hover:border-brand-primary hover:shadow-sm transition-all flex gap-4 items-start"
              >
