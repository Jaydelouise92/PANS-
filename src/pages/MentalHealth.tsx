      ...
      <section className="py-6 px-6 bg-red-50 border-b border-red-200">
        <div className="max-w-5xl mx-auto flex gap-3 items-start">
          ...
          <p className="text-sm text-red-800">
            <strong>In crisis right now?</strong> Call <a href="tel:131114" className="font-bold underline decoration-red-200 hover:text-red-600 transition-colors">Lifeline on 13 11 14</a> (24/7) or <a href="tel:000" className="font-bold underline decoration-red-200 hover:text-red-600 transition-colors">000</a> if you are in immediate danger. You do not have to face this alone.
          </p>
        </div>
      </section>
              ...
              <motion.div key={i} initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.08 }} className={`bg-white border-2 ${line.urgent ? 'border-red-200' : 'border-purple-100'} p-5 rounded-2xl flex gap-4 items-start`}>
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-2xl font-bold text-brand-primary mb-1 block hover:underline"
                  >
                    {line.number}
                  </a>
