        ...
        <div className="max-w-3xl mx-auto prose prose-stone max-w-none space-y-8">
          <div>
            ...
            <p className="text-stone-700 leading-relaxed">
              ...
              published on <strong>jaydelouise92.github.io/PANS-</strong> are the intellectual
          ...
          <div>
            ...
            <ul className="space-y-2 text-stone-700">
              ...
              <li>• Quote a short passage from a guide if you clearly credit "PANS Victoria — jaydelouise92.github.io/PANS-" and link back to the source page.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-stone-700 leading-relaxed">
              ...
              <em className="block mt-2 not-italic bg-brand-secondary border border-purple-100 rounded-xl p-4 text-sm">
                ...
                <em>[Page title]</em>. Retrieved from https://jaydelouise92.github.io/PANS-
              </em>
            </p>
          </div>
