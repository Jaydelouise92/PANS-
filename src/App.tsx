...
function AppLayout() {
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 z-[100] bg-brand-primary text-white px-4 py-2 rounded-lg font-bold shadow-lg outline-none"
      >
