...
function AppLayout() {
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-white focus:text-brand-primary focus:border-2 focus:border-brand-primary focus:rounded-lg focus:shadow-xl focus:outline-none font-bold"
      >
