...
// ⚡ Bolt Optimization: Moved outside to maintain referential stability
...
// ⚡ Bolt Optimization: Memoized message component to prevent re-renders when typing in the input field
const MessageItem = memo(({ m, i, onSpeak, onFeedback, feedbackStatus }: {
  m: Message;
  i: number;
  onSpeak: (text: string) => void;
  onFeedback: (i: number, rating: 'positive' | 'negative') => void;
            ...
            <div className="bg-brand-primary px-4 py-3 text-white flex justify-between items-center shrink-0">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  aria-label={isThinkingMode ? 'Deep thinking on' : 'Fast mode'}
