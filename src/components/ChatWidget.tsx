        ...
        {message.role === 'assistant' && (
          <div className="flex items-center gap-1 mt-1 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <button
              ...
              className={`p-1 transition-colors ${feedback === 'positive' ? 'text-green-500' : 'text-stone-400 hover:text-green-500'}`}
              title="Helpful"
            >
              <ThumbsUp size={12} />
            </button>
            <button
              ...
              className={`p-1 transition-colors ${feedback === 'negative' ? 'text-red-500' : 'text-stone-400 hover:text-red-500'}`}
              title="Not helpful"
            >
              <ThumbsDown size={12} />
            </button>
