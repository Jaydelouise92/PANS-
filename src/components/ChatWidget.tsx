...
// ⚡ Helper to render message text with basic markdown-like formatting.
...
// ⚡ MessageItem is memoized to prevent expensive re-renders and text re-parsing
// when the user types in the chat input or other unrelated state changes.
const MessageItem = React.memo(({ message, index, onSpeak, onFeedback, feedbackStatus }: MessageItemProps) => {
  return (
