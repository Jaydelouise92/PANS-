            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={i} className="flex flex-col">
                  ...
                  <a href={`tel:${c.number.replace(/\s/g, '')}`} className="font-bold text-brand-primary text-sm hover:underline transition-colors w-fit">
                    {c.number}
                  </a>
                </li>
              ))}
            ...
            <div className="flex gap-3 items-start">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-amber-700">
                  If you are in immediate danger or crisis, contact emergency services on <strong><a href="tel:000" className="hover:underline">000</a></strong> or Lifeline on <strong><a href="tel:131114" className="hover:underline">13 11 14</a></strong>.
                </p>
              </div>
            </div>
          </div>
